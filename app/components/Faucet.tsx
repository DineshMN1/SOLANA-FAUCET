...
const Faucet = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-black text-white">
      {/* Title */}
      <h1 className="text-4xl font-bold absolute top-20 bg-gradient-to-r from-purple-500 to-pink-400 bg-clip-text text-transparent text-center">
        Solana Faucet
      </h1>
      ...
      <div className="w-96 bg-black border border-gray-600 p-6 rounded-lg shadow-lg flex flex-col items-center mt-5">
        <form onSubmit={handleAirdrop} className="w-full flex flex-col items-center">
          ...
          <button
            type="submit"
            disabled={loading}
            className="bg-purple-200 text-black px-5 py-2 rounded w-full mt-3 hover:bg-violet-300 transition duration-300"
          >
